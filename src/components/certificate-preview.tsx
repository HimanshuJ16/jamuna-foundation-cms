...
export function CertificatePreview({ formData, isFormValid }: CertificatePreviewProps) {
  ...
  const generatePreview = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "Failed to generate certificate preview")
    } finally {
      setLoading(false)
    }
  }
        ...
        {!isFormValid && !error && (
          <div className="flex items-center justify-center h-96 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
            <div className="text-center text-gray-500">
              ...
              <p className="text-lg font-medium">Fill the form to see certificate preview</p>
        ...
        {previewUrl && !loading && (
          <div className="space-y-4">
            <div className="bg-green-50 border border-green-200 rounded-lg p-3">
              <p className="text-green-800 text-sm font-medium">🏆 Certificate preview ready!</p>
              <p className="text-green-700 text-xs">This is how your certificate will look when generated</p>
            </div>

            <div className="border rounded-lg overflow-hidden">
              <iframe src={previewUrl} className="w-full h-96" title="Certificate Preview" style={{ border: "none" }} />
            </div>
